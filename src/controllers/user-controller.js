...
//
//
//     let credential = EmailAuthProvider.getCredential(user.email, oldPassword);
...
//     try {
//         let currentUser = await _auth.currentUser();
...
//     try {
//         let user = await _auth.signInWithEmailAndPassword(email, password);
//         if (user != null) {
...
// ) => {
//     try {
//         let user = await _auth.createUserWithEmailAndPassword(email, password);
//
//         await user.user.sendEmailVerification();
//
//         if (user !== null) {
