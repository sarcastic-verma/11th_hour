...
const Card404 = () => (
    <div className = "error404">
        ...
        <div className = "maindiv"> 
            ...
            <h1> Hello? Is somebody here?!?</h1> <br></br>
            <h2>We know it's scary but the page you're trying to reach can't be found. Perhaps it was a bad <strike>link</strike> dream.</h2>
        </div>
    </div>
);
